...
INSERT INTO `reservation` (`id`,`id_oeuvrevente`, `id_adherent`, `date_reservation`, `statut`) VALUES
(1, 10002, 3, '2017-06-14', 'en attente'),
(2, 10003, 3, '2013-02-22', 'confirmee'),
(3, 10004, 7, '2013-02-22', 'confirmee'),
(4, 10005, 8, '2018-06-04', 'confirmee'),
(5, 10005, 9, '2019-08-06', 'confirmee');
