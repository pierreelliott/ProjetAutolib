...
<t:layout>
    <jsp:attribute name="title">Médiathèque de Polytech - Modifier une réservation</jsp:attribute>
    <jsp:body>
        ...
        <form method="post" action="<c:url value="/reservations/modifierReservation"/>">
